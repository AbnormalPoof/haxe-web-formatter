...
$hx_exports["formatter"] = $hx_exports["formatter"] || {};
...
var formatter_Formatter = $hx_exports["formatter"]["Formatter"] = function() { };
...
formatter_Formatter.formatString = function(input,configData) {
	var result = formatter_Formatter.format(formatter_FormatterInput.Code(input,formatter_CodeOrigin.Snippet),formatter_Formatter.loadConfigString(configData));
...
formatter_Formatter.loadConfigString = function(configData) {
...
formatter_Formatter.main = function() {
	var result = formatter_Formatter.format(formatter_FormatterInput.Code(" trace ( 'foo' ) ; ",formatter_CodeOrigin.Snippet),new formatter_config_Config(),null,tokentree_TokenTreeEntryPoint.ExpressionLevel);
	switch(result._hx_index) {
	case 0:
		$global.console.log("Success: " + result.formattedCode);
		break;
	case 1:
		$global.console.log("Failed to format: " + result.errorMessage);
		break;
	case 2:
...
var formatter_FormatterInput = $hxEnums["formatter.FormatterInput"] = { __ename__:true,__constructs__:null
	,Code: ($_=function(code,origin) { return {_hx_index:0,code:code,origin:origin,__enum__:"formatter.FormatterInput",toString:$estr,__params__:function(){ return [this.code,this.origin];}}; },$_._hx_name="Code",$_)
	,Tokens: ($_=function(tokenList,tokenTree,code,origin) { return {_hx_index:1,tokenList:tokenList,tokenTree:tokenTree,code:code,origin:origin,__enum__:"formatter.FormatterInput",toString:$estr,__params__:function(){ return [this.tokenList,this.tokenTree,this.code,this.origin];}}; },$_._hx_name="Tokens",$_)
};
